...
__all__ = [
    ...
    'UIA_Window_WindowClosedEventId', 'ScrollAmount_SmallDecrement',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'StyleId_Heading2', 'UIA_WindowWindowVisualStatePropertyId',
    'PropertyConditionFlags_None', 'SynchronizedInputType',
    'IUIAutomationSpreadsheetPattern', 'IUIAutomationBoolCondition',
    'UIA_OverlineStyleAttributeId', 'UIA_TabControlTypeId',
    'IUIAutomationMultipleViewPattern',
    'UIA_SplitButtonControlTypeId', 'TreeScope_Element',
    'UIA_LineSpacingAttributeId', 'UIA_EditControlTypeId',
    'CoalesceEventsOptions', 'IUIAutomationCustomNavigationPattern',
    'StyleId_Heading3', 'StyleId_Emphasis', 'NotificationProcessing',
    'AutomationElementMode', 'UIA_RangeValueMaximumPropertyId',
    'UIA_TextFlowDirectionsAttributeId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'UIA_AccessKeyPropertyId', 'CUIAutomation',
    'ProviderOptions_UseClientCoordinates', 'UIA_TableControlTypeId',
    'WindowVisualState_Normal', 'UIA_GroupControlTypeId',
    'SynchronizedInputType_KeyDown',
    'ProviderOptions_ClientSideProvider',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_InvokePatternId', 'DockPosition_Bottom',
    'UIA_DropTarget_DroppedEventId',
    'UIA_Selection2ItemCountPropertyId', 'Off', 'Polite',
    'UIA_TreeControlTypeId', 'IUIAutomationNotCondition',
    'UIA_IsTransformPatternAvailablePropertyId',
    'TreeTraversalOptions', 'UIA_IsTablePatternAvailablePropertyId',
    'UiaChangeInfo', 'UIA_ForegroundColorAttributeId',
    'UIA_ValuePatternId', 'UIA_IndentationLeadingAttributeId',
    'LiveSetting', 'IUIAutomationObjectModelPattern',
    'UIA_ChangesEventId', 'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_SemanticZoomControlTypeId', 'UIA_ProcessIdPropertyId',
    'OrientationType_Vertical', 'NotificationKind_ActionAborted',
    'UIA_DockDockPositionPropertyId', 'UIA_AsyncContentLoadedEventId',
    'UIA_IsItalicAttributeId', 'IUIAutomationElementArray',
    ...
    'UIA_LevelPropertyId', 'AnnotationType_Footnote',
    'UIA_ScrollItemPatternId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'ScrollAmount_SmallIncrement', 'AutomationElementMode_Full',
    'UIA_CapStyleAttributeId', 'UIA_IsActiveAttributeId',
    'UIA_ButtonControlTypeId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_DropTarget_DragLeaveEventId', 'IUIAutomationElement2',
    'UIA_MenuModeEndEventId', 'UIA_SpreadsheetItemFormulaPropertyId',
    'SynchronizedInputType_KeyUp', 'UIA_LiveSettingPropertyId',
    'UIA_ToolBarControlTypeId', 'UIA_DataGridControlTypeId',
    'UIA_WindowIsModalPropertyId', 'UIA_HyperlinkControlTypeId',
    'UIA_SizeOfSetPropertyId', 'WindowInteractionState_Running',
    'HeadingLevel_None', 'UIA_CheckBoxControlTypeId',
    'StyleId_Heading1', 'IUIAutomationAndCondition',
    'AnnotationType_SpellingError',
    'UIA_RangeValueIsReadOnlyPropertyId', 'DockPosition_Top',
    'UIA_StylesPatternId', 'ProviderOptions_ProviderOwnsSetFocus',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_LocalizedLandmarkTypePropertyId', 'HeadingLevel4',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_LinkAttributeId', 'ExpandCollapseState_PartiallyExpanded',
    'IUIAutomationOrCondition', 'StructureChangeType_ChildRemoved',
    'UIA_DropTarget_DragEnterEventId',
    'SynchronizedInputType_LeftMouseDown', 'UIA_IsHiddenAttributeId',
    'UIA_NativeWindowHandlePropertyId',
    'AnnotationType_UnsyncedChange', 'IUIAutomationRangeValuePattern',
    'UIA_SayAsInterpretAsMetadataId',
    'NavigateDirection_PreviousSibling',
    'ExpandCollapseState_Expanded', 'IUIAutomationElement6',
    'DockPosition_Fill', 'IUIAutomationStructureChangedEventHandler',
    'StyleId_Custom', 'AnnotationType_Endnote',
    'UIA_FlowsToPropertyId', 'IUIAutomationAnnotationPattern',
    'IUIAutomationInvokePattern',
    'UIA_IsDockPatternAvailablePropertyId',
    'ProviderOptions_RefuseNonClientSupport', 'TreeScope_Children',
    'TextUnit_Word', 'UIA_MarginTopAttributeId',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_StructureChangedEventId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_FontWeightAttributeId', 'IUIAutomationProxyFactory',
    'OrientationType', 'IUIAutomationItemContainerPattern',
    'AnnotationType_CircularReferenceError',
    'UIA_IsKeyboardFocusablePropertyId',
    'TreeTraversalOptions_LastToFirstOrder', 'UIA_GridPatternId',
    'UIA_TextChildPatternId', 'IUIAutomationTextRange2',
    'WindowInteractionState', 'UIA_SelectionPattern2Id',
    'StructureChangeType', 'IUIAutomationTextEditPattern',
    'UIA_TransformPatternId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'IUIAutomationTogglePattern',
    'NotificationProcessing_ImportantAll', 'IUIAutomation2',
    'UIA_CultureAttributeId', 'UIA_ToolTipClosedEventId',
    'UIA_StylesShapePropertyId', 'TreeTraversalOptions_PostOrder',
    'UIA_SelectionActiveEndAttributeId', 'UIA_ListItemControlTypeId',
    'UIA_StylesStyleIdPropertyId', 'ExpandCollapseState_LeafNode',
    ...
    'UIA_RotationPropertyId', 'ExpandCollapseState_Collapsed',
    'ScrollAmount', 'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_IsPeripheralPropertyId', 'IUIAutomationTablePattern',
    'AnnotationType_DataValidationError',
    'UIA_Transform2CanZoomPropertyId', 'UIA_ToolTipControlTypeId',
    'UIA_AutomationFocusChangedEventId', 'UIA_LandmarkTypePropertyId',
    'IUIAutomationProxyFactoryMapping', 'UIA_HeadingLevelPropertyId',
    'UIA_AutomationPropertyChangedEventId',
    'NavigateDirection_Parent',
    'AnnotationType_AdvancedProofingIssue',
    'IRawElementProviderSimple', 'UIA_GridItemColumnPropertyId',
    'IUIAutomationElement8', 'UIA_StyleIdAttributeId',
    'IUIAutomationTextPattern', 'UIA_TextPattern2Id', 'HeadingLevel2',
    'UIA_FlowsFromPropertyId', 'IUIAutomationScrollItemPattern',
    'UIA_TableItemRowHeaderItemsPropertyId', 'StyleId_Quote',
    'UIA_CulturePropertyId', 'UIA_SpinnerControlTypeId',
    'ExtendedProperty', 'CUIAutomation8',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_TextEdit_ConversionTargetChangedEventId', 'Assertive',
    'UIA_AnnotationObjectsAttributeId',
    'StructureChangeType_ChildrenReordered',
    'UIA_VirtualizedItemPatternId',
    'UIA_ActiveTextPositionChangedEventId',
    'IUIAutomationNotificationEventHandler',
    'UIA_ValueValuePropertyId', 'IUIAutomationExpandCollapsePattern',
    'UIA_IsSubscriptAttributeId', 'UIA_CaretPositionAttributeId',
    'TreeScope_Parent', 'IUIAutomationSelectionPattern2',
    'IUIAutomationElement5', 'UIA_TextEditPatternId',
    'AnnotationType_Sensitive',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'UIA_CalendarControlTypeId',
    'IUIAutomationVirtualizedItemPattern',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_HeaderItemControlTypeId', 'UIA_AnnotationTargetPropertyId',
    'UIA_LabeledByPropertyId', 'ZoomUnit_SmallIncrement',
    'UIA_WindowWindowInteractionStatePropertyId',
    'IUIAutomationPropertyChangedEventHandler',
    'WindowVisualState_Maximized', 'UIA_Text_TextChangedEventId',
    'UIA_AppBarControlTypeId', 'UIA_GridRowCountPropertyId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'StructureChangeType_ChildAdded',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_TransformPattern2Id', 'HeadingLevel6',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_SpreadsheetItemPatternId', 'UIA_IsReadOnlyAttributeId',
    'UIA_LegacyIAccessiblePatternId', 'UIA_ValueIsReadOnlyPropertyId',
    'UIA_TransformCanMovePropertyId',
    'AnnotationType_ConflictingChange',
    'RowOrColumnMajor_ColumnMajor', 'AnnotationType_InsertionChange',
    'UIA_UnderlineColorAttributeId', 'TextEditChangeType_Composition',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_NotificationEventId', 'UIA_ControlTypePropertyId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'ExpandCollapseState', 'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_TableRowHeadersPropertyId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_ScrollBarControlTypeId', 'UIA_ThumbControlTypeId',
    'UIA_TablePatternId', 'UIA_MultipleViewPatternId',
    'AnnotationType_EditingLockedChange',
    'ProviderOptions_HasNativeIAccessible', 'UIA_DockPatternId',
    'ProviderOptions', 'UIA_ClickablePointPropertyId',
    'DockPosition_None', 'UIA_ItemTypePropertyId',
    'UIA_WindowPatternId', 'UIA_IsGridPatternAvailablePropertyId',
    'UIA_StylesExtendedPropertiesPropertyId',
    'AnnotationType_GrammarError', 'UIA_StylesFillColorPropertyId',
    'UIA_UnderlineStyleAttributeId', 'UIA_DragDropEffectsPropertyId',
    'TextEditChangeType_AutoComplete',
    'UIA_AnnotationDateTimePropertyId',
    'NavigateDirection_FirstChild', 'IUIAutomationDockPattern',
    'PropertyConditionFlags_IgnoreCase', 'UIA_TabItemControlTypeId',
    'NotificationKind_ItemRemoved', 'WindowVisualState_Minimized',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_HelpTextPropertyId', 'UIA_CaretBidiModeAttributeId',
    'WindowInteractionState_Closing', 'UIA_OutlineColorPropertyId',
    'UIA_TableRowOrColumnMajorPropertyId',
    'IUIAutomationTextRangeArray', 'IUIAutomation',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_AnnotationAuthorPropertyId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'AnnotationType_Highlighted', 'IUIAutomationScrollPattern',
    'AnnotationType_Comment', 'UIA_LiveRegionChangedEventId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_AnnotationTypesAttributeId',
    'TextPatternRangeEndpoint_Start', 'IAccessible',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_OutlineThicknessPropertyId', 'UIA_Drag_DragStartEventId',
    'UIA_BulletStyleAttributeId', 'UIA_TextPatternId',
    'UIA_RangeValuePatternId',
    'TextEditChangeType_CompositionFinalized',
    'SupportedTextSelection_Single',
    'NotificationProcessing_CurrentThenMostRecent',
    'UIA_StrikethroughStyleAttributeId', 'TextUnit',
    'UIA_AcceleratorKeyPropertyId', 'UIA_AriaPropertiesPropertyId',
    'UIA_SayAsInterpretAsAttributeId', 'UIA_PositionInSetPropertyId',
    'UIA_TreeItemControlTypeId', 'UIA_SliderControlTypeId',
    'UIA_ObjectModelPatternId', 'UIA_WindowControlTypeId',
    'AnnotationType_FormatChange', 'ScrollAmount_LargeDecrement',
    'IUIAutomationElement4', 'UIA_IsWindowPatternAvailablePropertyId',
    'NotificationKind_Other', 'UIA_DragIsGrabbedPropertyId',
    'TextPatternRangeEndpoint', 'UIA_ImageControlTypeId',
    'IUIAutomationElement9', 'UIA_AutomationIdPropertyId',
    'IUIAutomationDropTargetPattern', 'UIA_AnimationStyleAttributeId',
    'HeadingLevel9', 'UIA_AnnotationAnnotationTypeIdPropertyId',
    'NotificationProcessing_All', 'UIA_FrameworkIdPropertyId',
    'IUIAutomationElement7', 'UIA_SeparatorControlTypeId',
    'StyleId_Heading7', 'TreeScope_Ancestors',
    'UIA_SystemAlertEventId', 'UIA_TextEdit_TextChangedEventId',
    'UIA_PaneControlTypeId', 'UIA_DescribedByPropertyId',
    'IUIAutomationElement3', 'UIA_TitleBarControlTypeId',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'TextUnit_Character', 'TreeTraversalOptions_Default',
    'UIA_IsTextPatternAvailablePropertyId', 'AnnotationType_Author',
    'UIA_FontNameAttributeId', 'UIA_LocalizedControlTypePropertyId',
    'UIA_SummaryChangeId', 'UIA_ControllerForPropertyId',
    'UIA_CenterPointPropertyId', 'UIA_IsEnabledPropertyId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_Invoke_InvokedEventId', 'HeadingLevel7',
    'IUIAutomationEventHandler', 'UIA_FillColorPropertyId',
    'UIA_MenuItemControlTypeId', 'UIA_MarginLeadingAttributeId',
    'RowOrColumnMajor_Indeterminate', 'AnnotationType_ExternalChange',
    'AnnotationType_Footer', 'ToggleState',
    'ProviderOptions_UseComThreading',
    'UIA_AnnotationObjectsPropertyId',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_SynchronizedInputPatternId', 'AnnotationType_Unknown',
    'UIA_SelectionItemSelectionContainerPropertyId', 'TextUnit_Line',
    'UIA_FullDescriptionPropertyId', 'OrientationType_Horizontal',
    'IUIAutomationChangesEventHandler',
    'IUIAutomationSelectionPattern', 'ZoomUnit_NoAmount',
    'UIA_SizePropertyId', 'UIA_IndentationTrailingAttributeId',
    'UIA_CustomControlTypeId', 'SupportedTextSelection_Multiple',
    'HeadingLevel3', 'UIA_InputReachedOtherElementEventId',
    'NotificationKind_ItemAdded', 'UIA_MenuControlTypeId',
    'IUIAutomation6', 'UIA_DragPatternId',
    'UIA_CustomNavigationPatternId', 'UIA_RangeValueValuePropertyId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'TextEditChangeType_None', 'UIA_DragGrabbedItemsPropertyId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_ClassNamePropertyId', 'ProviderOptions_ServerSideProvider',
    'UIA_BackgroundColorAttributeId',
    'UIA_ScrollVerticalViewSizePropertyId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'IUIAutomationEventHandlerGroup', 'UIA_DocumentControlTypeId',
    'UIA_Drag_DragCompleteEventId',
    'UIA_LegacyIAccessibleChildIdPropertyId', 'UIA_NamePropertyId',
    'NavigateDirection_NextSibling',
    'UIA_LegacyIAccessibleRolePropertyId',
    'UIA_StrikethroughColorAttributeId', 'UIA_CustomLandmarkTypeId',
    'UIA_TextControlTypeId', 'UIA_TableColumnHeadersPropertyId',
    'DockPosition', 'AnnotationType_Mathematics', 'IUIAutomation3',
    'ConnectionRecoveryBehaviorOptions',
    ...
    'UIA_InputDiscardedEventId', 'TextEditChangeType',
    'UIA_GridItemContainingGridPropertyId',
    'UIA_ItemContainerPatternId', 'TextEditChangeType_AutoCorrect',
    'ZoomUnit', 'UIA_SelectionSelectionPropertyId',
    'UIA_NavigationLandmarkTypeId', 'IUIAutomationTextRange3',
    'AnnotationType_MoveChange', 'RowOrColumnMajor_RowMajor',
    'AnnotationType_Header', 'UIA_WindowIsTopmostPropertyId',
    ...
    'UIA_SelectionItemPatternId', 'UIA_WindowCanMaximizePropertyId',
    'UIA_SelectionPatternId', 'UIA_AriaRolePropertyId',
    'SupportedTextSelection_None', 'UIA_IsDataValidForFormPropertyId',
    'HeadingLevel5', 'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_GridItemRowPropertyId', 'UIA_Transform2ZoomLevelPropertyId',
    'UIA_FontSizeAttributeId', 'RowOrColumnMajor',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'IUIAutomationTransformPattern', 'UIA_MenuOpenedEventId',
    'UIA_IsContentElementPropertyId',
    'UIA_Selection_InvalidatedEventId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'SynchronizedInputType_LeftMouseUp', 'TreeScope_None',
    'UIA_TabsAttributeId', 'NotificationProcessing_MostRecent',
    'ZoomUnit_LargeDecrement', 'UIA_Text_TextSelectionChangedEventId',
    'StyleId_Heading9', 'UIA_AnnotationPatternId',
    'UIA_GridItemRowSpanPropertyId', 'TreeScope_Subtree',
    'UIA_IsSelectionPattern2AvailablePropertyId', 'TextUnit_Format',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_ScrollVerticallyScrollablePropertyId', 'TextUnit_Document',
    'UIA_ListControlTypeId', 'AnnotationType_TrackChanges',
    'TextUnit_Paragraph', 'UIA_AnnotationTypesPropertyId',
    'UIA_IsControlElementPropertyId',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_WindowCanMinimizePropertyId', 'StyleId_Normal',
    'UIA_IsDialogPropertyId', 'UIA_StylesFillPatternStylePropertyId',
    'UIA_OverlineColorAttributeId', 'UIA_FillTypePropertyId',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_MainLandmarkTypeId', 'IUIAutomationProxyFactoryEntry',
    'ProviderOptions_OverrideProvider', 'UIA_MarginBottomAttributeId',
    'UIA_RangeValueMinimumPropertyId', 'UIA_IsOffscreenPropertyId',
    'ZoomUnit_SmallDecrement', 'HeadingLevel8',
    'IUIAutomationPropertyCondition',
    'UIA_LegacyIAccessibleStatePropertyId',
    'UIA_OutlineStylesAttributeId', 'UIA_MenuModeStartEventId',
    'IUIAutomationTreeWalker', 'UIA_ComboBoxControlTypeId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_MenuClosedEventId', 'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_DropTargetPatternId',
    'UIA_ScrollHorizontalScrollPercentPropertyId', 'StyleId_Heading5',
    'IUIAutomationTextChildPattern', 'ToggleState_On',
    'UIA_ToolTipOpenedEventId', 'IUIAutomationTextPattern2',
    'IUIAutomationCondition', 'UIA_IsRequiredForFormPropertyId',
    'AnnotationType_FormulaError', 'UIA_Window_WindowOpenedEventId',
    'UIA_ScrollPatternId', 'UIA_GridItemPatternId',
    'UIA_InputReachedTargetEventId', 'UIA_ProgressBarControlTypeId',
    'UIA_BeforeParagraphSpacingAttributeId',
    'IUIAutomationValuePattern', 'UIA_ToggleToggleStatePropertyId',
    'UIA_BoundingRectanglePropertyId', 'StyleId_Subtitle',
    'UIA_DragDropEffectPropertyId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_ItemStatusPropertyId', 'IUIAutomationTextRange',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_IsSuperscriptAttributeId', 'ZoomUnit_LargeIncrement',
    'IUIAutomation4', 'IUIAutomationLegacyIAccessiblePattern',
    'IUIAutomationGridItemPattern', 'IUIAutomationDragPattern',
    'UIA_DataItemControlTypeId', 'UIA_SearchLandmarkTypeId',
    'NavigateDirection', 'UIA_HeaderControlTypeId',
    'StyleId_Heading6', 'UIA_StatusBarControlTypeId',
    'ScrollAmount_NoAmount', 'IUIAutomationCacheRequest',
    'UIA_StyleNameAttributeId', 'UIA_RuntimeIdPropertyId',
    'UIA_TogglePatternId', 'IUIAutomationStylesPattern',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_IsPasswordPropertyId',
    'UIA_IsTextChildPatternAvailablePropertyId', 'TreeScope',
    'OrientationType_None', 'UIA_ExpandCollapsePatternId',
    'IUIAutomationTableItemPattern', 'UIA_LayoutInvalidatedEventId',
    'ToggleState_Off', 'UIA_TableItemPatternId',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'AutomationElementMode_None',
    'UIA_Transform2ZoomMaximumPropertyId',
    'IUIAutomationTransformPattern2', 'ToggleState_Indeterminate',
    'UIA_IndentationFirstLineAttributeId', 'StyleId_Heading8',
    'IUIAutomationGridPattern',
    'UIA_AfterParagraphSpacingAttributeId',
    'NavigateDirection_LastChild', 'UIA_HasKeyboardFocusPropertyId',
    'IUIAutomationSynchronizedInputPattern',
    'AnnotationType_DeletionChange', 'UIA_Drag_DragCancelEventId',
    'DockPosition_Right', 'UIA_SelectionItem_ElementSelectedEventId',
    ...
    'UIA_TransformCanRotatePropertyId', 'UIA_OrientationPropertyId',
    'ScrollAmount_LargeIncrement', 'WindowVisualState',
    'NotificationKind_ActionCompleted', 'UIA_FormLandmarkTypeId',
    'StyleId_BulletedList', 'IUIAutomationSelectionItemPattern',
    'IUIAutomationElement', 'UIA_StylesStyleNamePropertyId',
    'NotificationKind', 'HeadingLevel1', 'TreeScope_Descendants',
    'UIA_MarginTrailingAttributeId', 'TextUnit_Page',
    'UIA_SpreadsheetPatternId', 'PropertyConditionFlags',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'StyleId_Title', 'UIA_RadioButtonControlTypeId',
    'SupportedTextSelection',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'CoalesceEventsOptions_Enabled', 'UIA_MenuBarControlTypeId',
    'WindowInteractionState_ReadyForUserInteraction',
    'IUIAutomation5', 'StyleId_NumberedList',
    'UIA_StylesFillPatternColorPropertyId', 'StyleId_Heading4'
]

_check_version('1.1.14', 1658228859.174888)
